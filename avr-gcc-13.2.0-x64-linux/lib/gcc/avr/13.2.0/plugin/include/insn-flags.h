...
#define HAVE_difficult_branch (reload_completed)
#define HAVE_jump 1
...
#define HAVE_gen_add_for_eq_qi 1
#define HAVE_gen_add_for_ne_qi 1
...
extern rtx        gen_gen_add_for_eq_qi              (rtx, rtx, rtx, rtx);
extern rtx        gen_gen_add_for_ne_qi              (rtx, rtx, rtx, rtx);
