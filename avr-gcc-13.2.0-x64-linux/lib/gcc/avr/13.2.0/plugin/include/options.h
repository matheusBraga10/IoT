...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 437,             /* -Waddr-space-convert */
  ...
  OPT_Wanalyzer_allocation_size = 452,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 453,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 454,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 455,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 456,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 457,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 458,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 459,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 460,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 461,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 462,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 463,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 464,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 465,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 466,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 467,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_recursion = 468,    /* -Wanalyzer-infinite-recursion */
  ...
  OPT_Wanalyzer_tainted_assertion = 483,     /* -Wanalyzer-tainted-assertion */
  ...
  OPT_Wmisspelled_isr = 687,                 /* -Wmisspelled-isr */
  ...
  OPT_list = 1886,                           /* -list */
  OPT_mabsdata = 1887,                       /* -mabsdata */
  OPT_maccumulate_args = 1888,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1889,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1890,                /* -mcall-prologues */
  OPT_mdeb = 1891,                           /* -mdeb */
  OPT_mdouble_ = 1892,                       /* -mdouble= */
  OPT_mfract_convert_truncate = 1893,        /* -mfract-convert-truncate */
  OPT_mgas_isr_prologues = 1894,             /* -mgas-isr-prologues */
  OPT_mint8 = 1895,                          /* -mint8 */
  OPT_mlog_ = 1896,                          /* -mlog= */
  OPT_mlong_double_ = 1897,                  /* -mlong-double= */
  OPT_mmain_is_OS_task = 1898,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1899,                          /* -mmcu= */
  OPT_mn_flash_ = 1900,                      /* -mn-flash= */
  OPT_mno_interrupts = 1901,                 /* -mno-interrupts */
  OPT_morder1 = 1902,                        /* -morder1 */
  OPT_morder2 = 1903,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1904,              /* -mpmem-wrap-around */
  OPT_mrelax = 1905,                         /* -mrelax */
  OPT_mrmw = 1906,                           /* -mrmw */
  OPT_mshort_calls = 1907,                   /* -mshort-calls */
  OPT_mskip_bug = 1908,                      /* -mskip-bug */
  OPT_msp8 = 1909,                           /* -msp8 */
  OPT_mstrict_X = 1910,                      /* -mstrict-X */
  OPT_mtiny_stack = 1911,                    /* -mtiny-stack */
  OPT_n = 1912,                              /* -n */
  OPT_name_sort = 1913,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1914,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1915,              /* -no-integrated-cpp */
  OPT_no_pie = 1916,                         /* -no-pie */
  OPT_nocpp = 1917,                          /* -nocpp */
  OPT_nodefaultlibs = 1918,                  /* -nodefaultlibs */
  OPT_nodevicelib = 1919,                    /* -nodevicelib */
  OPT_nodevicespecs = 1920,                  /* -nodevicespecs */
  ...
  OPT_static_libgm2 = 1966,                  /* -static-libgm2 */
  OPT_static_libgo = 1967,                   /* -static-libgo */
  OPT_static_libhwasan = 1968,               /* -static-libhwasan */
  OPT_static_liblsan = 1969,                 /* -static-liblsan */
  OPT_static_libmpx = 1970,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1971,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1972,               /* -static-libphobos */
  OPT_static_libquadmath = 1973,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1974,               /* -static-libstdc++ */
  OPT_static_libtsan = 1975,                 /* -static-libtsan */
  OPT_static_libubsan = 1976,                /* -static-libubsan */
  OPT_static_pie = 1977,                     /* -static-pie */
  /* OPT_std_c__03 = 1978, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1979, */                /* -std=c++0x */
  OPT_std_c__11 = 1980,                      /* -std=c++11 */
  OPT_std_c__14 = 1981,                      /* -std=c++14 */
  OPT_std_c__17 = 1982,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1983, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1984, */                /* -std=c++1z */
  OPT_std_c__20 = 1985,                      /* -std=c++20 */
  OPT_std_c__23 = 1986,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1987, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1988, */                /* -std=c++2b */
  OPT_std_c__98 = 1989,                      /* -std=c++98 */
  OPT_std_c11 = 1990,                        /* -std=c11 */
  OPT_std_c17 = 1991,                        /* -std=c17 */
  /* OPT_std_c18 = 1992, */                  /* -std=c18 */
  /* OPT_std_c1x = 1993, */                  /* -std=c1x */
  OPT_std_c2x = 1994,                        /* -std=c2x */
  /* OPT_std_c89 = 1995, */                  /* -std=c89 */
  OPT_std_c90 = 1996,                        /* -std=c90 */
  OPT_std_c99 = 1997,                        /* -std=c99 */
  /* OPT_std_c9x = 1998, */                  /* -std=c9x */
  OPT_std_f2003 = 1999,                      /* -std=f2003 */
  OPT_std_f2008 = 2000,                      /* -std=f2008 */
  OPT_std_f2008ts = 2001,                    /* -std=f2008ts */
  OPT_std_f2018 = 2002,                      /* -std=f2018 */
  OPT_std_f95 = 2003,                        /* -std=f95 */
  OPT_std_gnu = 2004,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2005, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2006, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2007,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2008,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2009,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2010, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2011, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2012,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2013,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2014, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2015, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2016,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2017,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2018,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2019, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2020, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2021,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2022, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2023,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2024,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2025, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2026, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2027,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2028, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2029, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2030, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2031, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2032, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2033,                     /* -std=legacy */
  OPT_stdlib_ = 2034,                        /* -stdlib= */
  OPT_symbol_ = 2035,                        /* -symbol= */
  OPT_symbolic = 2036,                       /* -symbolic */
  OPT_t = 2037,                              /* -t */
  OPT_time = 2038,                           /* -time */
  OPT_time_ = 2039,                          /* -time= */
  OPT_traditional = 2040,                    /* -traditional */
  OPT_traditional_cpp = 2041,                /* -traditional-cpp */
  OPT_tree_stats = 2042,                     /* -tree-stats */
  OPT_trigraphs = 2043,                      /* -trigraphs */
  OPT_type_stats = 2044,                     /* -type-stats */
  OPT_u = 2045,                              /* -u */
  OPT_undef = 2046,                          /* -undef */
  OPT_v = 2047,                              /* -v */
  OPT_version = 2048,                        /* -version */
  OPT_w = 2049,                              /* -w */
  OPT_wrapper = 2050,                        /* -wrapper */
  OPT_x = 2051,                              /* -x */
  OPT_z = 2052,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
